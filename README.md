...
2. **`ai-log/`** — o processo completo: 170 mensagens da sessão OpenCode exportadas em texto (`.md` + `.json`), mais o registro por fase (`fase0..7.md`).

## Estrutura

```
src/                     # código Python reexecutável (Fases 0-7)
...
ai-log/                  # conversas de IA exportadas (processo = 30% da nota)
  ...
  fase0..7.md            #   registro do processo por fase
